...
" remap double backslash to removing search highlights after I'm done.
nnoremap // :noh<return>
...
" enable soft wrapping at the edge of screen
set wrap
...
" Link the Conceal highlight group to the Special highlight group to fix background color issues
